...
public class ReflectDemo {
    ...
    public static void main(String[] args) {
        ...
        DisplayConfig displayConfig2 = new DisplayConfig(null, "functionType", "detailType",
                "姓名", "", "",
                "com.cycle.rubbish.demo.temp.ReflectDemo.DisplayConfig", "valueDefault", "",
                1, "-单位",
        ...
        DisplayConfig displayConfig3 = new DisplayConfig(null, "functionType", "detailType",
                "姓名（${valueUnit}）", "com.cycle.rubbish.demo.temp.ReflectDemo.DisplayConfig", "valueUnit",
                "com.cycle.rubbish.demo.temp.ReflectDemo.DisplayConfig", "valueUnit", "",
                1, "-单位",
                "productType", "subProductType", "dictName", null, null, null, null);
        try {
